...
{
    public class ArborNodeEx : ArborNode
    {
        public Color Color;
        ...
        {
			int i = 0;
			this.Color = Color.FromName(setColor);
		}
    }
    ...
    public sealed class ArborViewer : Panel, IArborRenderer
    {
        ...
        public Dictionary<int, string> nodes1 = new Dictionary<int, string>();
        public Dictionary<int, string> nodes2 = new Dictionary<int, string>();
        ...
        public ArborViewer()
        {
            ...
            this.fSys = new ArborSystemEx(0, 0/*1000*/, 0, this);
        ...
        //public void doSample(string node1,string node2)
        //{
        //    fSys.addNode("kek")/*.Mass = 50*/;
        //    fSys.addEdge("kek", "lol"/*, 10*/);
        //    fSys.addEdge("lol", "kek2"/*, 10*/);
		...
		public void doSample(string node1, string node2)
		{
			fSys.addNode(node1);
			fSys.addNode(node2);
			fSys.addEdge(node1, node2);
			

		}
		public void doSample(string nodeStart)
		{
			fSys.addNode(nodeStart)/*.Mass = 50*/;
